...
public:
	...
	bool cmd_login();
	bool cmd_submit(const char* sJobId, uint32_t iNonce, uint32_t iNonceUpper, const uint8_t* bResult, const char* backend_name, uint64_t backend_hashcount, uint64_t total_hashcount, const xmrstak_algo& algo);
