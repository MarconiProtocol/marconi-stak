...
void help()
{
	...
	cout<< "Some changes were made so that this miner is compatible with Marconi Protocol." << endl;
	cout<< "Previous versions brought to you by fireice_uk and psychocrypt." << endl;
	cout<< "This code remains under GPLv3." << endl;
}
...
int main(int argc, char *argv[])
{
	...
	printer::inst()->print_str("\n\n");
	printer::inst()->print_str("Some changes were made so that this miner is compatible with Marconi Protocol.\n");
	printer::inst()->print_str("Previous versions brought to you by fireice_uk and psychocrypt.\n");
	printer::inst()->print_str("This code remains under GPLv3.\n");
